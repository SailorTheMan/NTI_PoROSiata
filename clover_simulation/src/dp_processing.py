...
def getContours(img, imgContour):
    ...
    for cnt in contours:
        ...
        minArea = 20 #cv2.getTrackbarPos('minArea', 'Parameters')
        if area > minArea:
...
def image_callback(data):
    ...
    threshold1 = 136 #cv2.getTrackbarPos('Threshold1', 'Parameters')
    threshold2 = 136 #cv2.getTrackbarPos('Threshold2', 'Parameters')
